...
for chr in $(seq 1 22);do
   ...
   /home/imgtaka/LDSC/make_annot.py  \
      --bimfile  /home/ha7477/reference/LDSCORE/1000G_Phase3_EAS_plinkfiles/1000G.EAS.QC.$chr.bim  \
   ...
   /home/imgtaka/LDSC/ldsc/ldsc.py \
      --l2  \
      --thin-annot  \
      --bfile  /home/ha7477/reference/LDSCORE/1000G_Phase3_EAS_plinkfiles/1000G.EAS.QC.$chr   \
      --ld-wind-cm  1  \
      --annot  $odir/$data.$chr.annot.gz  \
      --out   $odir/$data.$chr  \
      --print-snps  /home/ha7477/reference/LDSCORE/baseline_eas_v1.2/$chr.snps
