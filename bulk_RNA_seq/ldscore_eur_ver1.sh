...
for chr in $(seq 1 22);do
   ...
   $HOME/LDSC/make_annot.py  \
      --bimfile  ${LDSCORE_path}/1000G_Phase3_EUR_plinkfiles/1000G.EUR.QC.$chr.bim \
   ...
   $HOME/LDSC/ldsc/ldsc.py \
      --l2  \
      --thin-annot  \
      --bfile  ${LDSCORE_path}/1000G_Phase3_EUR_plinkfiles/1000G.EUR.QC.$chr   \
      --ld-wind-cm  1  \
      --annot  $odir/$data.$chr.annot.gz  \
      --out   $odir/$data.$chr  \
      --print-snps  ${LDSCORE_path}/baseline_v1.2/$chr.snps
